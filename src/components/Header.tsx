  ...
  return (
    <header className={classes.header}>
              ...
              <Group justify="space-between">
                ...
                >
                  <Menu.Target>
                    ...
                    >
                      <Group gap={7}>
                        <Avatar src={user?.photoURL} alt='user photo' radius="xl" size={32} name={user?.displayName?.split(' ').slice(0, 2).map(word => word.charAt(0).toUpperCase()).join('') || undefined} color="initials" />
      ...
      <Drawer opened={opened} onClose={toggle} size="15rem"
        ...
        <Group>
          <Avatar src={user?.photoURL} alt='user photo' radius="xl" size={56} name={user?.displayName?.split(' ').slice(0, 2).map(word => word.charAt(0).toUpperCase()).join('') || undefined} color="initials" />
